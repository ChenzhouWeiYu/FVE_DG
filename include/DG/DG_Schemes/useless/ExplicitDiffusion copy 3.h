            ...
            if(cells[1] == uInt(-1)) {
                ...
                for(uInt g=0; g<QuadF::num_points; ++g) {
                    ...
                    for(uInt j=0; j<Basis::NumBasis; ++j) {
                        ...
                        #pragma omp atomic update
                        result[cells[0]](5*j+0,0) += flux_L(0,0) * jac_weight;
                        #pragma omp atomic update
                        result[cells[0]](5*j+1,0) += flux_L(1,0) * jac_weight;
                        #pragma omp atomic update
                        result[cells[0]](5*j+2,0) += flux_L(2,0) * jac_weight;
                        #pragma omp atomic update
                        result[cells[0]](5*j+3,0) += flux_L(3,0) * jac_weight;
                        #pragma omp atomic update
                        result[cells[0]](5*j+4,0) += flux_L(4,0) * jac_weight;
                        #pragma omp atomic update
                        result[cells[1]](5*j+0,0) -= flux_R(0,0) * jac_weight;
                        #pragma omp atomic update
                        result[cells[1]](5*j+1,0) -= flux_R(1,0) * jac_weight;
                        #pragma omp atomic update
                        result[cells[1]](5*j+2,0) -= flux_R(2,0) * jac_weight;
                        #pragma omp atomic update
                        result[cells[1]](5*j+3,0) -= flux_R(3,0) * jac_weight;
                        #pragma omp atomic update
                        result[cells[1]](5*j+4,0) -= flux_R(4,0) * jac_weight;
                    }
